      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <p className="text-gray-700 mb-8">
            ...
            The team’s diverse expertise enables the firm to address complex environmental challenges holistically
            and deliver integrated solutions that are both innovative and practical.
          </p>
        </div>

        {/* Right Column - Glassmorphic Image Slideshow */}
